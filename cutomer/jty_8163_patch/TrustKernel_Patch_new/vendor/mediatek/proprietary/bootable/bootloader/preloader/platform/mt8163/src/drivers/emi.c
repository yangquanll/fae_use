...
static void init_lpddr3(EMI_SETTINGS *emi_setting)
{
	...
	*((V_UINT32P)(DRAMC0_BASE + 0x01c0)) = 0x00000000;
	*((V_UINT32P)(DDRPHY_BASE + 0x01c0)) = 0x00000000;
	...
	*((V_UINT32P)(DDRPHY_BASE + 0x0410)) = 0x33330000;
	...
	if ( *(V_UINT32P)(EMI_CONA)& 0x20000)
    {
    	*((V_UINT32P)(DRAMC0_BASE + 0x0110)) = 0x0b063411;				//Edward: cross rank timing.
    	*((V_UINT32P)(DDRPHY_BASE + 0x0110)) = 0x0b063411;
    }
    else
    {
	...
	*((V_UINT32P)(DDRPHY_BASE + 0x01e4)) = 0x00001100;
	...
	// Edward : add two rank enable here.
	if ( *(V_UINT32P)(EMI_CONA)& 0x20000)  {
			*((V_UINT32P)(DRAMC0_BASE + 0x0110)) = 0x00163491;
			*((V_UINT32P)(DDRPHY_BASE + 0x0110)) = 0x00163491;
	} else {
			*((V_UINT32P)(DRAMC0_BASE + 0x0110)) = 0x00112390;
			*((V_UINT32P)(DDRPHY_BASE + 0x0110)) = 0x00112390;
	}
	...
	*((V_UINT32P)(DDRPHY_BASE + 0x01dc)) = emi_setting->DRAMC_PD_CTRL_VAL;	//enable DDRPHY dynamic clk gating
    ...
    if ( *(V_UINT32P)(EMI_CONA)& 0x20000)
    {
		*((V_UINT32P)(DRAMC0_BASE + 0x0110)) = 0x00163401; //0x00112381;		//dsiable R_DMMRS2RK, this bit enable will impact MRR result // Edward : Modify [14:12] XRTR2W 1->2 [10:8] XRTR2R 1->3
		*((V_UINT32P)(DDRPHY_BASE + 0x0110)) = 0x00163401; //0x00112381;		//dsiable R_DMMRS2RK, this bit enable will impact MRR result
    }
    else
  	{
                   ...
                   enum reserve_rank rank)
{
	...
	for (i = 0; i < mblock_info->mblock_num; i++) {
		...
		printf("Trustkernel using new patch...............\n");
