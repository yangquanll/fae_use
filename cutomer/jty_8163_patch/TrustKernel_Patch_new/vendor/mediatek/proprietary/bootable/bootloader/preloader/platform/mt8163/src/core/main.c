...
static char *check_active_part(char *name1, char *name2)
{
    int ret;
            ...
            if (get_bootup_status(ab_suffix)) { //boot_successfully == 1
                ...
                if (ab_retry > 0) {
                    ...
                    if (!memcmp(ab_suffix, BOOTCTRL_SUFFIX_A, 2)) {
                        ...
                        if (mmc_switch_part(EMMC_PART_BOOT2)) {
                            print("fail to switch preloader b");
                            ASSERT(0);
                        }
                    } else {
                        ab_suffix = BOOTCTRL_SUFFIX_A;
                        if (mmc_switch_part(EMMC_PART_BOOT1)) {
                            print("fail to switch preloader a");
                            ASSERT(0);
                        }
                    }
