...
#endif
static void clear_sdrpmb_value(tee_arg_t_ptr ptr){
	ptr->sdrpmb_partaddr=0;
	ptr->sdrpmb_partsize=0;
	ptr->sdrpmb_nr_sectors=0;
	ptr->sdrpmb_starting_sector=0;
}
