...
#define TEE_INSTALL_SYSTA_IOC			_IOW('t', 180, struct tee_ta_inst_desc)

#define TEE_INSTALL_TA_IOC				_IOWR('t', 174, struct tee_spta_inst_desc)
#define TEE_INSTALL_TA_RESP_IOC			_IO('t', 175)
#define TEE_DELETE_TA_IOC				_IOWR('t', 176, TEEC_UUID)
