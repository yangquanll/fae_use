...
import org.ifaa.android.manager.TrustKernelIFAAManager;

public class TAInterationV2 {
    ...
    public static Result sendCommand(TrustKernelIFAAManager  manager, Context context, int command) {
    ...
    public static Result sendCommandAndData(TrustKernelIFAAManager manager, Context context, int command, byte[] data) {
    ...
    private static byte[] doSendData(TrustKernelIFAAManager manager, Context context, byte[] data) {
        
        return manager.processCmdV2( context, data);
    }
