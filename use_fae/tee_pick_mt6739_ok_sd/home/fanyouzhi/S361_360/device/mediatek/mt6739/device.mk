...
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6739/media_profiles_ducam.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml:mtk
...
#add by BTL LYJ start
###ifeq ($(strip $(MTK_FINGERPRINTD_SUPPORT)),yes)
$(call inherit-product, vendor/btlfp/btlproduct.mk) 
