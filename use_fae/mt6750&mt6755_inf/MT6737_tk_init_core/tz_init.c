...
void trustzone_post_init(void)
{
...
#elif CFG_TRUSTKERNEL_TEE_SUPPORT
    DBG_MSG("%s TrustKernel Generate rpmb key with seclib\n", MOD);
    ...
    DBG_MSG("%s TrustKernel SDRPMB init \n", MOD);
#endif
